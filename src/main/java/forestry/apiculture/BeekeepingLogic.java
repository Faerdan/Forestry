...
public class BeekeepingLogic implements IBeekeepingLogic, IStreamable {
	...
	public boolean canWork() {
		...
		if (canWork && (!queen.getGenome().getPrimary().isJubilant(queen.getGenome(), housing) || !queen.getGenome().getSecondary().isJubilant(queen.getGenome(), housing)))
		{
			errorLogic.setCondition(true, EnumErrorCode.NOT_JUBILANT);
		}
