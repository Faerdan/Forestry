...
public interface IAlleleBeeSpecies extends IAlleleSpecies {
	...
	/**
	 * @return Required biome name patterns
	 */
	Pattern[] getRequiredBiomeNamePatterns();

	/**
	 * @return Does biome match required biome name
	 */
	boolean doesBiomeMatchRequired(BiomeGenBase biome);
